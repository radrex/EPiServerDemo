namespace DevGoodies.Models.Blocks
{
    ...
    [ContentType(DisplayName = "WelcomeBlock", GUID = "251ff436-86ac-4f5a-966b-0f2326bcb313", GroupName = Groups.Blocks, Order = 10,
    ...
    public class WelcomeBlock : BlockData
    {
        ...
        [UIHint(UIHint.Image)]
        [Display(Name = "Image", GroupName = SystemTabNames.PageHeader, Order = 20)]
        public virtual ContentReference WelcomeImage { get; set; }

        [Display(Name = "Link", GroupName = SystemTabNames.PageHeader, Order = 30)]
        public virtual PageReference WelcomeLink { get; set; }

        [CultureSpecific]
        [Display(Name = "Rich text", Order = 10)]
